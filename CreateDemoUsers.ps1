...
#
# User properties
$ou = "OU=Test-OU,DC=local,DC=yamboo,DC=se"  # Which OU to create the user in
$initialPassword = "Password1"               # Initial password set for the user
$orgShortName = "local"                      # This is used to build a user's sAMAccountName
$dnsDomain = "local.yamboo.se"               # Domain is used for e-mail address and UPN
$company = "Yamboo test user"                # Used for the user object's company attribute
...
[System.Collections.ArrayList]$phoneCountryCodes = @{"NL" = "+31"; "GB" = "+44"; "DE" = "+49"; "SE" = "+46"; "DK" = "+45"; "NO" = "+47", "FI" = "+358"}         # Country codes for the countries used in the address file
